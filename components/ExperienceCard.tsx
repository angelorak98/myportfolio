...
export const ExperienceCard: React.FC<ExperienceCardProps> = ({ item }) => {
  ...
  return (
    <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
        ...
        <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-slate-800/50 p-4 rounded-lg border border-slate-700 transition-all duration-300 group-hover:border-teal-500 group-hover:bg-slate-800 group-hover:shadow-2xl group-hover:scale-[1.12] hover:z-10 relative">
